...
def get_cfg():
    ...
    parser.add_argument("--model_path", type=str, default="C:/repos/2021_QWAP_SHI/output/model/episode30.pt", help="model file path")
    ...
    parser.add_argument("--save_every", type=int, default=10, help="Save a model every x episodes")
    parser.add_argument("--new_instance_every", type=int, default=10, help="Generate new scenarios every x episodes")

    parser.add_argument("--val_dir", type=str, default='input/validation/v2/25-80/', help="directory where the validation data are stored")
