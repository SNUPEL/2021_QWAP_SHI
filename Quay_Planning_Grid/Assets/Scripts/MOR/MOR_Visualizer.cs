...
{
    public static MOR_Visualizer Instance { get; private set; }
    ...
    public MOR_Runtime FindMShipAtQuay(string quayName)
    {
        ...
        foreach (MOR_Runtime mship in FindObjectsOfType<MOR_Runtime>())
        {
            MOR_Controller ai = mship.GetComponent<MOR_Controller>();
...
#if UNITY_EDITOR
    [ContextMenu("Auto-Fill MOR_Waypoint Renderers")]
    private void AutoFillSPTRenderers()
    {
        AutoFillRenderersByTag("MOR_Waypoint");
    }
