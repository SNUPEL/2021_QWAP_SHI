...
public class MWKR_Runtime : MonoBehaviour
{
    public ShipData Data;
    public List<SimulationData> Logs = new List<SimulationData>();
    private MWKR_Controller controller;
    ...
    {
        controller = GetComponent<MWKR_Controller>();
    ...
    private void CalculateLossCost(int currentSimDay)
    {
        ...
        MWKR_Controller ai = GetComponent<MWKR_Controller>();
        if (ai == null)
        {
