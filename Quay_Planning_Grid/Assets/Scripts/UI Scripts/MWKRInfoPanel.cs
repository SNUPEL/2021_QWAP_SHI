...
public class MWKRInfoPanel : MonoBehaviour
{
    ...
    private MWKR_Runtime currentShip;
    private int lastSimDay = -1;

    public void UpdateShipInfo(MWKR_Runtime selectedShip, int currentSimDay)
    {
    ...
    string FormatOperation(MWKR_Runtime ship, int index)
    {
